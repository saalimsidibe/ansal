            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{url('active/assets/img/testimonials/testimonials-1.jpg')}}" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{url('active/assets/img/testimonials/testimonials-2.')}}'" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{url('active/assets/img/testimonials/testimonials-3.jpg')}}" alt="Image" class="img-fluid">
                    </figure>
